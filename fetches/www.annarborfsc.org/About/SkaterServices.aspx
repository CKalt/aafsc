...
<head><meta charset="utf-8" /><title>
	Skater Services - Ann Arbor Figure Skating Club
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="4185D194" />
<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="y9iWjT4+95nHmcFRoGyrKr3piNZAEIdNZydseVhLRePLJoCXFaNOzZ5DEaeOQcTBVVkMZwJ1JN0dMtBqyzpo/wQnj85c5T/3SqxoO9Lp0t+OhPx17jVDYGxqYF7k6Nxgq6YWJyj+4pmBg/mrJ5ywag==" />
                    ...
                    <div class="collapse navbar-collapse navbar-responsive-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li id="menuMembership" class="dropdown">
                                <a href="SkaterServices.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">About AAFSC
                            ...
                            <li class="dropdown">
                                <a href="SkaterServices.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Programs
                            ...
                            <li class="dropdown">
                                <a href="SkaterServices.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Ice Sessions & Testing
                            ...
                            <li class="dropdown">
                                <a href="SkaterServices.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Competitions and Events
                            ...
                            <li class="dropdown">
                                <a href="SkaterServices.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">AAFSC Store
    ...
    <div class="breadcrumbs margin-bottom-40">
        <div class="container">
            <h1 class="pull-left">Please visit our sponsors</h1>
...
<div class="row servive-block margin-bottom-10">
     <div class="col-md-3 col-sm-6">
        <div class="servive-block-in servive-block-colored servive-block-red">
                        ...
                        <p>Are you a provider of sales and services for skaters?  If so, contact the AAFSC office about opportunities to list your products or service here on our site.</p>
                    </div>
    </div>
    </div>

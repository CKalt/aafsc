...
<head><meta charset="utf-8" /><title>
	General Information - Ann Arbor Figure Skating Club
...
<body>
    <form method="post" action="GeneralInformation.aspx" id="ctl01">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="D010C2C9" />
<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="dS3xfb3th+VjHXk3CYhFtFv0kBk+Sd1sllqUSf95YtyQps/lw5tyS5puID0MT13CZ9W4UkcCKDcUrQNGAYepi+fblKBTrO94PGqdHjffkfaosvEPye7zVS5h+K7LG0lCqj3wS8xefKjg3MduT8Lfgw==" />
                    ...
                    <div class="collapse navbar-collapse navbar-responsive-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li id="menuMembership" class="dropdown">
                                <a href="GeneralInformation.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">About AAFSC
                            ...
                            <li class="dropdown">
                                <a href="GeneralInformation.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Programs
                            ...
                            <li class="dropdown">
                                <a href="GeneralInformation.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Ice Sessions & Testing
                            ...
                            <li class="dropdown">
                                <a href="GeneralInformation.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Competitions and Events
                            ...
                            <li class="dropdown">
                                <a href="GeneralInformation.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">AAFSC Store
    ...
    <div class="breadcrumbs margin-bottom-40">
        <div class="container">
            <h1 class="pull-left">General Information</h1>
    ...
    <div class="container">
        <div class="row">
           <p> The Ann Arbor Figure Skating Club (AAFSC) was established in 1939 to encourage and develop the sport of figure skating in the community, and is one of the largest skating clubs in the country. The club is located in one of the nicest facilities in the region, the Ann Arbor Ice Cube. We offer group lessons and individual coaching in all aspects of skating - basic skills, free skating, moves in the field, pairs, dance, and synchronized teams. We teach all levels, from beginning to advanced, for all ages from 3 to 93.

AAFSC is a member of US Figure Skating, which in turn belongs to the International Skating Union. These organizations lead highly talented skaters through regional, sectional and national competition, and on to international competitions, the World Championships and the Olympic Games.

We host major competitions and shows which bring in 200 to 2,000 skaters each plus their coaches, parents, spouses, siblings and friends. The AAFSC has several ways for you to advertise your local business to our visitors.

In addition, many members of the AAFSC community serve as officials and on Committees for the USFSA and PSA organizations.
&nbsp;</p>
            <br />
        </div>
        ...
        <div class="search-blocks search-blocks-colored search-blocks-blue">
            <div class="row">
                <div class="col-md-4 search-img">
                    <img id="MainContent_Image1" class="img-responsive" src="../images/12AAFSC-Winter-0129-SM-CE.jpg" />
                </div>
                <div class="col-md-8">
                    <h2>AAFSC Mission Statement</h2>
                    ...
                    <p>
                        It is the Mission of the Ann Arbor Figure Skating Club:<br />
                        •To promote, foster and encourage full participation in the growth and development of figure skating<br />
                        •To encourage and assist amateur figure skating and participation in local and international competition<br />
                        •To educate and inform the public of all aspects of the benefits to be derived from figure skating<br />
                        •To maintain a club that will provide membership for individuals interested in the promotion of educational activities concerning figure skating, and<br />
                        •To take all steps necessary to promote amateur figure skating in the State of Michigan
                    </p>
                ...
                <p>
                    The AAFSC serves the skating community and beyond as it strives to provide state of the art programs, education, and opportunities for skater excellence in a safe, supportive and fun environment.
                </p>
...
DEI Mission (Diversity, Equity, and Inclusion)

        <br />
        <br />
        <strong>The Ann Arbor Figure Skating Club is committed to providing an inclusive, welcoming environment to all.

</strong>
        <br />
        <br />
        •	We believe that achieving excellence on and off the ice requires a
community of individuals with diverse experiences and backgrounds.

<br />
        •	We strive to provide equal opportunity to athletes, members,
coaches, trainers, employees, officials and guests to participate in
club activities without discrimination on the basis of race, color, sex,
age, education, national origin, religion, sexual orientation, gender
identity and/or expression, veteran status, disability, or any other
federal, state or local protected class.

        <br />
        •	The AAFSC is committed to improving diversity, equity, and
inclusion to better reflect, serve, and engage our communities.

...
<head><meta charset="utf-8" /><title>
	AAFSC General Calendar - Ann Arbor Figure Skating Club
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="74942777" />
<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="3psyDyCR1oa6DHSHpVftES1fD6CFm99xXjDr2k82Czq04s6dcSMlgcipDwpgmclkibEezfWK+pVBTdy+8xFH7pvVzfgSyoUUAKw9gcuKHxlae/1uC+B1BLjpG3E5SV7w797dFJ4R8R8hpukvMr5+1g==" />
                    ...
                    <div class="collapse navbar-collapse navbar-responsive-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li id="menuMembership" class="dropdown">
                                <a href="GeneralCalendar.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">About AAFSC
                            ...
                            <li class="dropdown">
                                <a href="GeneralCalendar.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Programs
                            ...
                            <li class="dropdown">
                                <a href="GeneralCalendar.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Ice Sessions & Testing
                            ...
                            <li class="dropdown">
                                <a href="GeneralCalendar.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Competitions and Events
                            ...
                            <li class="dropdown">
                                <a href="GeneralCalendar.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">AAFSC Store
    ...
    <div class="breadcrumbs margin-bottom-40">
        <div class="container">
            <h1 class="pull-left">General Calendar</h1>
            <ul class="pull-right breadcrumb">
                <li><a href="../default.aspx">Home</a></li>
                <li class="active">General Calendar</li>
            </ul>
        </div>
        <!--/container-->
    </div>
    ...
    <!--=== End Breadcrumbs ===-->
        ...
        <div class="row margin-bottom-10">
            ...
            <iframe src="https://calendar.google.com/calendar/b/1/embed?height=600&amp;wkst=1&amp;bgcolor=%23FFFFFF&amp;src=aafsc%40annarborfsc.org&amp;color=%2329527A&amp;ctz=America%2FNew_York" style="border: 0" width="1000" height="600" frameborder="0" scrolling="no"></iframe>

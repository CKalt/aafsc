...
<head><meta charset="utf-8" /><title>
	Log in - Ann Arbor Figure Skating Club
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="CD85D8D2" />
<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="ysijBsemciO3vxCt4fuRCo6rNYTQbdnbHmv1yN3ZuBE8BaK9iqshN6EnmegGF2bX6+N6WqPTcyneXbMwZEyoYRVxv0EeQpH8+xSOvRR1Fu+IizPgg/euNW+wsrSKNoTraExaatfPQxrWkIm5P7UCFNFSGn7EBgtGvkZ0bqZxbJaNrXVZ2Pqhh0PrgwrxXwT1axBXRE999Kziyh2hYkrOV06tfSpcqAbF8H54yTaQXA4=" />
            ...
            <div class="container">
                <ul class="loginbar pull-right">
                    <li><em>It's about the Skater: Accomplishment.Atmosphere.Attitude.Together.</em>&nbsp;&nbsp;&nbsp;&nbsp;<input type="image" name="ctl00$imgDonate" id="imgDonate" src="../images/DonateButton.png" onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;ctl00$imgDonate&quot;, &quot;&quot;, true, &quot;&quot;, &quot;&quot;, false, false))" /></li>
                            ...
                            <li>
                                <a id="hlLogin" href="Login.aspx">Admin Log In</a></li>
                    ...
                    <div class="collapse navbar-collapse navbar-responsive-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li id="menuMembership" class="dropdown">
                                <a href="Login.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">About AAFSC
                            ...
                            <li class="dropdown">
                                <a href="Login.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Programs
                            ...
                            <li class="dropdown">
                                <a href="Login.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Ice Sessions & Testing
                            ...
                            <li class="dropdown">
                                <a href="Login.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Competitions and Events
                            ...
                            <li class="dropdown">
                                <a href="Login.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">AAFSC Store
                ...
                <section id="loginForm">
                    <div class="form-horizontal">
                        ...
                        <div class="control-group">
                            <label for="MainContent_UserName" class="col-md-2 control-label">Email</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <input type="submit" name="ctl00$MainContent$btnLogIn" value="Log in" onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;ctl00$MainContent$btnLogIn&quot;, &quot;&quot;, true, &quot;&quot;, &quot;&quot;, false, false))" id="MainContent_btnLogIn" class="btn btn-default" />
                            </div>
                        </div>
                    </div>

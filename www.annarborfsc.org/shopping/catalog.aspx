...
<head><meta charset="utf-8" /><title>
	Catalog - Ann Arbor Figure Skating Club
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />


<script src="../Scripts/WebForms/MsAjax/MicrosoftAjax.js" type="text/javascript"></script>
<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="923F398D" />
<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="ONp0GuzgfxVEH5s5UGaqLP2NQzy3/xv3lpGD7PB1WVAoNyjMMnilJmbqwdQo+9sik9C+yIX5oHwquyVGHZIADGXztNt0IqYdJ7ejWoHPJGE+okdjc+e7BhHYfNe2dOX/olCiCavW0Ufx2YSNAE+0gW8UYo/hJG1+m1T9nia9Aws=" />
                    ...
                    <div class="collapse navbar-collapse navbar-responsive-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li id="menuMembership" class="dropdown">
                                <a href="catalog.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">About AAFSC
                            ...
                            <li class="dropdown">
                                <a href="catalog.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Programs
                            ...
                            <li class="dropdown">
                                <a href="catalog.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Ice Sessions & Testing
                            ...
                            <li class="dropdown">
                                <a href="catalog.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Competitions and Events
                            ...
                            <li class="dropdown">
                                <a href="catalog.aspx#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">AAFSC Store
                            
                                </a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <a id="hlCatalog" href="catalog.aspx">Online Catalog</a></li>
                                    <li>
                                        <a id="hlClubMerchandise" href="ClubMerchandise.aspx">Club Merchandise</a></li>                                    <li>
                                        <a id="hlShoppingCart" href="cart.aspx">My Cart</a></li>
                                </ul>
                            </li>
    ...
    <div class="container">
        <div class="row margin-bottom-10">
                    ...
                    <div id="MainContent_pnlExternal" class="reg-page">
	
                        <h3>External Catalog - Shop AAFSC Merchandise</h3>

                        <p>
                            <a id="MainContent_HyperLink1" href="https://kcspecialts.com/collections/ann-arbor-skating-club" target="_blank">Show your support - Click here to view the catalog of AAFSC merchandise</a>
                        </p>
                            ...
                            <table style="padding: 10px; width: 80%">
                                <tr>
                                    <td style="width: 160px">
                                        <img id="MainContent_repCatalog_imgUserPhoto_0" src="../../figureskating.blob.core.windows.net/aafsc-pictures/6e1b63ce-9a1c-4c4a-a44f-24acac43835e" /></td>
                                    <td>
                                        <a id="MainContent_repCatalog_lbProductName_0" href="javascript:__doPostBack(&#39;ctl00$MainContent$repCatalog$ctl00$lbProductName&#39;,&#39;&#39;)"><b><font size="6">License Plate Frame</font></b></a></td>
                                    <td>Price:
                                        <span id="MainContent_repCatalog_lblUnitPrice_0">$10.00</span></td>
                                </tr>
                            </table>
